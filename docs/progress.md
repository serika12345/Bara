...
B8-ARCH2i review package で示すべきもの:

- `bara-runtime/src/guest_image/mod.rs` の `GuestImage` が `ProgramImageMappedBytes` を
  保持する範囲
- B8 debug bundle が existing `ProgramImageMetadata.mapped_bytes()` を
