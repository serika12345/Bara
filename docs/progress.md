...
- active_branch: `task/b8-g5d-objc-argument-fixup-resolution`。B8-G5c PR #28
  ...
  を base にした stacked branch として扱う。latest commit は B8-G5d review package で
  報告する。
...
- next_action: B8-G5d branch を commit / push し、draft PR を開いて review gate で
  停止する。レビュー後の次 PR Gate は B8-G5e Helper Return Value Materialization。
