...
mod tests {
    ...
    fn binary_format_probe_report_serializes_mach_o_entry_point_and_segment_as_stable_json() {
        ...
        assert_eq!(
            binary_format_probe_report_to_json(&report).expect("probe report serializes"),
            "{\"format\":\"mach_o_64_little_endian\",\"status\":\"recognized_but_unsupported\",\"metadata\":{\"mach_o\":{\"file_type\":\"executable\",\"load_commands\":{\"count\":2,\"byte_size\":96,\"recognized_entry_points\":[{\"byte_size\":24,\"entryoff\":4660,\"stacksize\":8192}],\"recognized_segments\":[{\"byte_size\":72,\"name\":\"__TEXT\",\"vmaddr\":4294967296,\"fileoff\":0,\"filesize\":4660}],\"unsupported_commands\":[]},\"executable_image_conversion\":{\"status\":\"not_convertible\",\"blocker\":\"unsupported_image_mapping\"}}}}"
        );
    }
