...
pub use input::{
    ...
    resolve_mach_o_symbol_for_x86_va, resolve_mach_o_symbol_stub_for_target, BinaryFileBytes,
    ...
    MachOResolvedAddressSymbol, MachOResolvedStubSymbol, MachOSectionAddress,
    MachOSectionAlignment, MachOSectionByteSize, MachOSectionFileOffset, MachOSectionFlags,
    MachOSectionMetadata, MachOSectionName, MachOSectionRelocationCount,
    MachOSectionRelocationFileOffset, MachOSectionReserved1, MachOSectionReserved2,
    MachOSectionReserved3, MachOSegmentCommandHeaderMetadata, MachOSegmentFileOffset,
    MachOSegmentFileSize, MachOSegmentName, MachOSegmentVmAddr, MachOStubByteSize, MachOStubIndex,
    MachOStubSymbolName, MachOStubSymbolResolution, MachOStubSymbolResolutionBlocker,
    MachOStubSymbolResolutionStatus, MachOStubVirtualAddress, MachOSymbolAddressResolution,
    MachOSymbolAddressResolutionBlocker, MachOSymbolAddressResolutionStatus, MachOSymbolIndex,
    MachOSymbolName, RecognizedMachODyldInfoCommand, RecognizedMachODylibImportCommand,
