...
mod tests {
    ...
    #[cfg(target_os = "macos")]
    #[test]
    fn generate_b8_debug_bundle_advances_opcode_only_batch_to_rip_relative_load_blocker() {
        let temp_dir = TestTempDir::new(
            "generate_b8_debug_bundle_advances_opcode_only_batch_to_rip_relative_load_blocker",
        );
