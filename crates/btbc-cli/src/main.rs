...
mod tests {
    ...
    #[cfg(target_os = "macos")]
    #[test]
    fn generate_b8_debug_bundle_advances_rip_relative_mov_rdi_to_next_rex_mov_blocker() {
        let temp_dir = TestTempDir::new(
            "generate_b8_debug_bundle_advances_rip_relative_mov_rdi_to_next_rex_mov_blocker",
        );
